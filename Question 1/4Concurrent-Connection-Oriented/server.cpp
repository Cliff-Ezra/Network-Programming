...
// It establishes a connection with each client before exchanging data. In this example, the server creates a new thread for each client to handle their requests concurrently.
